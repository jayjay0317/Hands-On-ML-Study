...
- ordinal encoder: gives numbers 1, 2, 3, ... to each category. Ml algorithms will assume that two nearby values are more silimar than two distant values -> use one-hot encoding to resolve this issue
